---
title: Cluster guide
description: TrueCharts / Talos / Flux cluster overview and day-to-day navigation
---
...
Manifests: [nerddotdad/truecharts](https://github.com/nerddotdad/truecharts). Prose docs: this site (`docs/homelab/`).

```
truecharts/
├── clusters/main/
│   ├── kubernetes/     # core, system, my-apps, flux-system, …
│   ├── talos/
│   └── clusterenv.yaml
├── repositories/
├── custom_images/
├── .sops.yaml
└── age.agekey                   # local only; never commit
```
...
```bash
# Prefer clustertool (never raw sops for this repo)
clustertool decrypt   # edit clusters/main/clusterenv.yaml etc.
clustertool encrypt   # before commit
...
**GitOps repository:** [nerddotdad/truecharts](https://github.com/nerddotdad/truecharts)  
**Docs home:** [nerd.dad Homelab](https://nerd.dad/latest/homelab/)
